...
const secretWord = 'ProductManagement@ProjectB2';  // Palavra secreta usada para gerar e verificar tokens JWT
    ...
    if (authHeader) {
      ...
      jwt.verify(token, secretWord, (error, decoded) => {
        ...
        if (error) {
          ...
          req.usuario = { id: decoded.id, permissao: decoded.permissao, registro: decoded.registro};
